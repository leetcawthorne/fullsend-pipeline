"""
Full Send – Automated Content Generator (PoC)
--------------------------------------------
Generates simple SEO-friendly markdown articles from keyword prompts.
Requires no external APIs or paid tools.
...
# ------------- CONFIG -------------
# Default list of keywords/niches. You can later load these from niche_scores.csv
NICHES = [
...
def generate_article(keyword: str) -> str:
    """Generate simple SEO-style article text."""
...
def main():
    # Pick a random niche for daily generation
